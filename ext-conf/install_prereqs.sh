...
DEB_PKGS="pkg-config libltdl-dev librrd2-dev libsensors4-dev libsnmp-dev libyajl-dev \
          ...
          libcurl4-openssl-dev python-dev libperl-dev protoc-compiler \
          libprotobuf-dev protoc-c-compiler"
RH_PKGS="libtool-ltdl-devel libatasmart-devel lm_sensors-devel lvm2-devel \
         ...
         perl-ExtUtils-MakeMaker rpm-build protobuf-compiler \
         libprotobuf-devel protobuf-c-compiler"
